...
export default withRouter(function Ticket(props) {
    let { id, orderNumber, principalId, day } = props.data
    day = day.slice(5)
    return (
        // /entryNo/:type/:id/:orderNumber/:principalId
        // query: { type: props.type, title: tab[props.type], id, orderNumber, principalId }
        <div className="h_tickets" onClick={() => props.history.push({ pathname: `/entryNo/${props.type}/${id}/${orderNumber}/${principalId}`  })}>
